...
public class VariableSettings extends Sprite {
	...
	public var isCloudData:Boolean = false;
	...
	protected var cloudDataButton:IconButton;
	private var cloudDataLabel:TextField;
	...
	public static function strings():Array {
		return ['For this sprite only', 'For all sprites', 'list', 'variable', "Cloud list (stored on server)", "Cloud variable (stored on server)"];
	}
	...
	protected function addLabels():void {
		...
		addChild(cloudDataLabel = Resources.makeLabel(
			Translator.map(isList ? "Cloud list (stored on server)" : "Cloud variable (stored on server)"), CSS.normalTextFormat));
	}
	...
	protected function addButtons():void {
		...
		function setCloud(b:IconButton):void {isCloudData = !isCloudData}
		addChild(localButton = new IconButton(setLocal, null));
		addChild(globalButton = new IconButton(setGlobal, null));
		addChild(cloudDataButton = new IconButton(setCloud, 'checkbox'));
	}
