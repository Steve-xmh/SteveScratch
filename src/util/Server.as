...
//		}
	...
	// 保存指定信息，每个键值大小不超过 1MB
	public function setLocalData(key:String, value:* = null):Boolean {
		var sharedObj:SharedObject = SharedObject.getLocal('ScratchProjectData');//存档位置
	...
	public function getSelectedLang(whenDone:Function):void {
		...
		var sharedObj:SharedObject = SharedObject.getLocal('SteveScratch');
		if (sharedObj.data.lang) whenDone(sharedObj.data.lang);
		else whenDone(Capabilities.language);
	}
