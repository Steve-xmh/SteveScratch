...
public class BlockIO {
	...
	public static function stackToString(b:Block):String {
		return util.JSON.stringify(stackToArray(b),false);
	}
	...
	private static function arrayToBlock(cmd:Array, undefinedBlockType:String, forStage:Boolean = false):Block {
		...
		if (cmd[0] == 'setLocalData' || cmd[0] == 'getLocalData') Scratch.app.usesLocalDataBlock = true;
	...
	public static function jsonToCmd(blockData:String):Block 
	{
		
		return stringToStack(blockData);
