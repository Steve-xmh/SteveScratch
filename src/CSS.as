...
public class CSS {
	...
	public static const topBarColor_default:int = 0xFEA515 - 0x151515;//0x9C9EA2
	public static const tabColor:int = 0xFFFFFF;//0xE6E8E8
	...
	// Fonts
	public static const font:String = Resources.chooseFont(['等线','宋体', 'Arial', 'Verdana', 'DejaVu Sans']);
