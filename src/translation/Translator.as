...
public class Translator {
	...
	public static var languages:Array = [['zh-cn','zh_CN'],['zh-tw','zh_TW']]; // contains pairs: [<language code>, <utf8 language name>]
	...
	private static const font12:Array = ['fa', 'he','ja','ja_HIRA'];
	private static const font13:Array = ['ar', 'zh_CN', 'zh-cn', 'zh_TW', 'zh-tw'];

	private static var dictionary:Object = {};
	[Embed(source = "zh-cn.po", mimeType = "application/octet-stream")]
	private static const chineseText:Class;
	...
	public static function setLanguageValue(lang:String):void {
		...
		if ('en' == lang)
		{
			Scratch.app.translationChanged(); // there is no .po file English
		}
		else if ('zh-cn' == lang || 'zh-CN' == lang){
			gotPOFile(new chineseText() as ByteArray);
		}
		else {
