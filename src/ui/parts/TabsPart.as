...
public class TabsPart extends UIPart {
	...
	private var sscnTab:IconButton;
	...
	public function TabsPart(app:Scratch) {
		...
		function selectSSCN(b:IconButton):void {  }//app.setTab('SteveScratchCommuityNetwork')
		...
		sscnTab = makeTab('SteveScratchCommuityNetwork', selectSSCN);
		sscnTab.visible = false;
		addChild(scriptsTab);
		addChild(imagesTab);
		addChild(soundsTab);
		addChild(sscnTab);
	...
	public static function strings():Array {
		return ['Scripts', 'Costumes', 'Backdrops', 'Sounds', 'SteveScratchCommuityNetwork'];
	}
	...
	public function selectTab(tabName:String):void {
		...
		if (tabName == 'SteveScratchCommuityNetwork') sscnTab.turnOn();
	}
	...
	public function fixLayout():void {
		...
		soundsTab.y = 0;
		sscnTab.x = soundsTab.x + soundsTab.width + 1;
		sscnTab.y = 0;
		this.w = sscnTab.x + sscnTab.width;
