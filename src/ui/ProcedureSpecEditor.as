...
public class ProcedureSpecEditor extends Sprite {
	...
	public function ProcedureSpecEditor(originalSpec:String, inputNames:Array, warpFlag:Boolean, shape:int = BlockShape.CmdShape) {
	...
	private function addButtonsAndLabels():void {
		...
		var icon:BlockShape = new BlockShape(BlockShape.NumberShape, lightGray);
