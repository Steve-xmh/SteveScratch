...
public class ScratchSoundPlayer {
	...
	public var readPosition:int; //字节读取位置
	...
	public function startPlaying(doneFunction:Function = null, startTime:Number = 0):void {
		readPosition=0;
		dataBytes = new ByteArray();
		dataBytes.position=0;
		stopIfAlreadyPlaying();
		activeSounds.push(this);
		bytePosition = startOffset + startTime * 22050;//定位播放
