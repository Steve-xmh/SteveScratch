...
class Specs
{
    ...
    public static inline var FUNCALL : String = "funCall";
    public static inline var FUNRETURN : String = "funReturn";
    public static inline var PROCEDURE_DEF : String = "procDef";
    public static inline var PROCEDURE_RETDEF : String = "retProcDef";
    ...
    public static inline var steveBlocksCategory : Int = 13;
    public static inline var kindForNoobsCategory : Int = 14;
    ...
    public static function IconNamed(name : String) : Dynamic
    {
        ...
        if (name == "greenFlag")
        {
            icon = Resources.createBmp("flagIcon");
        }
        if (name == "stop")
        {
            icon = Resources.createBmp("stopIcon");
        }
        if (name == "turnLeft")
        {
            icon = Resources.createBmp("turnLeftIcon");
        }
        if (name == "turnRight")
        {
            icon = Resources.createBmp("turnRightIcon");
        }
        if (icon != null)
        {
